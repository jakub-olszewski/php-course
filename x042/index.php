    ...
    <body>
        <div style="margin: 50px">
            ...
            <p>
                Napisz skrypt, który :  
                <ul>
                    <li>będzie tworzył plik cookie zapamiętujący wprowadzoną przez formularz datę urodzin użytkownika.</li>
                    <li>wyświetlać będzie informację, za ile dni użytkownik będzie obchodził urodziny.</li>
                </ul>  
