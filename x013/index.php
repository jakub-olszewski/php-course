...
<html lang="pl">
    ...
    <body>
        <div style="margin: 50px">
            ...
            <p>
            Napisz skrypt, zawierający : <br>
                <ul>
                    <li>tablicę asocjacyjną przechowującą imiona 5 osób z grupy, kluczami mają być nazwiska uczniów<code></code></li>
                    <li>kod wyświetlający na stronie za pomocą pętli foreach wszystkie nazwiska i imiona<code></code></li>
                </ul>
